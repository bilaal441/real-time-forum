...
class PostView extends View {
  ...
  generateMarkUp(data) {
    ...
    <div class="post-actions">
      <button data-="post-comment" class="comment-button">Comment</button>
      <button data-="post-like" class="like-button">Like</button>
      <button data-="post-dislike" class="dislike-button">Dislike</button>
    </div></div>`),
      ""
    )}`;
  }
