  ...
  try {
    ...
    switch (data.query) {
      ...
      case "post-dislike":
        ...
        break;
      case "comment-like":
        const comments = await likeAndDislikeComment({query: data.query.split("-")[0], ...data});
        PostView.renderCommentReaction(comments);
        break;
      case "comment-dislike":
        await likeAndDislikeComment({query: data.query.split("-")[0], ...data});
        PostView.renderCommentReaction(comments);
        break;
      case "post-comment":
